...
def config_parser():
    ...
    parser.add_argument('--gs_config_file', type=str, help='gs config file path')
    parser.add_argument('--gui', action='store_true', help='active when specified')

    # general
    parser.add_argument('--data_dir', type=str, help='the directory for the video sequence')
    parser.add_argument('--seq_name', type=str, help='the directory for the video sequence')
    ...
    parser.add_argument('--down_scale', type=int, default=1, help='downscale factor for images')
    ...
    parser.add_argument('--base_idx', type=int, default=0, help='start idx images to train')
    ...
    parser.add_argument('--lr_depth', type=float, default=1e-2, help='learning rate for depth map')
    ...
    parser.add_argument('--loss_rgb_weight', type=float, default=1.0, help='the weight for each dataset')
    parser.add_argument('--loss_flow_weight', type=float, default=1.0, help='the weight for each dataset')
    parser.add_argument('--video_flow_margin', type=float, default=0.25, help='the weight for each dataset')
